    ...
    <div className="lg:flex stats-vertical lg:stats-horizontal container mx-auto my-20 lg:my-44">
      <div data-aos="zoom-in-right" className="stat place-items-center">
        ...
        <p>
          ...
          sapiente harum esse architecto unde doloribus! Nihil dignissimos
          laboriosam illo est maiores, eligendi aliquid voluptatum vel minus
          nisi corrupti et?
        </p>
        <button className="btn btn-wide btn-primary text-white mt-4">
          Get Started
          <ArrowRightIcon className="w-4 h-4 ml-2 text-white"></ArrowRightIcon>
        </button>
      </div>
      ...
      <div data-aos="zoom-in-down" className="stat place-items-center">
        ...
        <p>
          ...
          laboriosam voluptatum quos ullam. Architecto autem quod exercitationem
          dolores eum blanditiis, quia repudiandae reiciendis cumque quaerat
          explicabo, laudantium repellendus nulla rerum.
        </p>
        <button className="btn btn-wide btn-primary text-white mt-4">
          Get Started
          <ArrowRightIcon className="w-4 h-4 ml-2 text-white"></ArrowRightIcon>
      ...
      <div data-aos="zoom-in-left" className="stat place-items-center">
        ...
        <p>
          ...
          iure eum, sed dolore, soluta iusto ex commodi beatae consectetur
          doloremque atque rerum nam ea ullam odit accusantium maxime tempora
          at!
        </p>
        <button className="btn btn-wide btn-primary text-white mt-4">
          Get Started
