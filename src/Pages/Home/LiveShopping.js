    ...
    <div className="hero min-h-screen bg-base-200 p-8 mx-auto">
      <div className="hero-content p-8 lg:mx-12 bg-base-100 flex-col lg:flex-row-reverse">
        <div data-aos="fade-left">
          <div class="w-50 lg:w-80 lg:ml-12">
            <img
        ...
        <div data-aos="fade-right">
          ...
          <p className="py-6">
            ...
            quia labore maiores odio blanditiis minima a praesentium. Recusandae
            totam quaerat molestias ea quisquam facere iste explicabo illo
            excepturi similique!
          </p>
