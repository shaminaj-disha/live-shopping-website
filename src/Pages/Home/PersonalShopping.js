...
const PersonalShopping = () => {
    return (
        <div className="hero min-h-screen bg-base-100 py-8 px-4 my-8 lg:my-16">
                    ...
                    <div data-aos="fade-down-left" className='lg:ml-12'>
                        <div className='lg:flex'>
                            ...
                            <div className='lg:pr-2 hidden lg:block'>
                                <div className="avatar">
                                    <div className="w-48 rounded">
                                        <img src="https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt='' />
                                    </div>
                                </div>
                                <div className="avatar">
                                    <div className="w-48 rounded">
                                        <img src="https://images.unsplash.com/photo-1591085686350-798c0f9faa7f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1031&q=80" alt='' />
                                    </div>
                                </div>
                            </div>
                            <div>
