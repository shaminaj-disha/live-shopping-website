    ...
    return (
        <div className="hero min-h-screen bg-base-100 py-8">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src="https://placeimg.com/260/400/arch" className="max-w-sm rounded-lg shadow-2xl ml-12" alt='' />
                <div>
                    <h1 className="text-7xl font-bold">World-Leading Live Video Shopping</h1>
