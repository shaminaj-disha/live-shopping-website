      ...
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div data-aos="fade-down-left">
          ...
          <p className="py-6">
            ...
            nam eveniet corporis, provident corrupti impedit delectus ipsum, a
            molestiae, architecto ullam pariatur commodi velit maiores inventore
            necessitatibus debitis enim ducimus?
          </p>
          <div className="mb-8">
