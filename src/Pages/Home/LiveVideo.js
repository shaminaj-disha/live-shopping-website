    ...
    return (
        <div className="lg:relative hero min-h-screen bg-base-100 mx-auto py-8 lg:px-36 mt-12">
            <div className="hero-content flex-col lg:flex-row">
                <img src="https://placeimg.com/260/400/arch" className="lg:sticky top-0 z-50 max-w-sm rounded-lg shadow-2xl lg:mr-12" alt='' />
                <div>
                    ...
                    <div className='mt-8'>
                        <button className="btn btn-primary mr-4">Get Started</button>
                        <button className="btn btn-outline btn-primary">Explore One-to-Many</button>
                    </div>
                </div>
            </div>
        </div>
