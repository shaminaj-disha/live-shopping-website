...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-gray-900 text-base-200 lg:justify-center lg:justify-between">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-gray-900 text-base-200 border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p><span className='text-xl'>Neovotech Ltd.</span><br></br>Copyright &copy; 2022</p>
                </div>
